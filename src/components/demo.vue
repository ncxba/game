<template>
  <div>
    ...
    <div class="fuchuan bou"  style="" v-show="huns"><!--position: relative;-->
      <div class="hunghg">
        <left></left>

      </div>
      <div class="roof" @click="getswitch"></div>
...
.cain {
  background-color: #4b4690 !important;
...
.character p, .Features-por, .characterA p {
  text-align: center;
  color: #1a1a1a;
  font-size: 0.26rem;
  line-height: 0.7rem;
