<template>
  ...
  <div id="container">
    <div class="center">
      <h2>充值中心</h2>
      <img src="../imgs/close.png" alt="" @click="ytnn" class="recharge-close" width="">
      <div class="recharge">
        <div class="term">
          <p>充值金额：</p>
          <p>￥{{money}}</p>
...
#container{
  width: 65.3vmax !important;
  height: 75.3vmin !important;/*42vmax*/
}
.center {
  width: 66vmax !important;
  height: 76vmin !important;/*42vmax*/
  /*width: 100% !important;
